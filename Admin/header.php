...
<header class="header">
  <div class="two">
<h1 class="logoh1"><img src="logo.png" id="logo2"></h1>

<nav class="navbar">
        <ul class="navbar-list">
          <li><a class="navbar-link" href="index.php">User Data</a></li>
          <li><a class="navbar-link" href="form.php">Add Product</a></li>
          <li><a class="navbar-link" href="admin_product.php">Product Data</a></li>
          <li><a class="navbar-link" href="admin_contact.php">Feedback Data</a></li>
